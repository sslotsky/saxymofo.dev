...
is operating on the same input object, with some processes
augmenting the object in some way. Middleware chains are a
well known example, but for the sake of this post, let's
talk about something more people can relate to. Of course
